...
from .views import delete_product_view, get_progress_view, products_view, add_product_view, products_refresh_all, update_product_url_view, job_update_all_products_view, job_send_product_sale_summary_emails_view
...
urlpatterns = [
    ...
    path('job/sendproductsalesummaryemails', job_send_product_sale_summary_emails_view, name='job-send-discount-notification-emails'),
]
